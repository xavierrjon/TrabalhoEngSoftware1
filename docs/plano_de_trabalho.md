...
garantir alinhamento e produtividade. Isso inclui reuniões, canais de comunicação e ferramentas utilizadas. Principais elementos do gerenciamento de comunicação:
...
- Sprint Review (Revisão da Sprint) – No final da sprint, a equipe apresenta o que foi feito. - Sprint Retrospective (Retrospectiva da Sprint) – Discussão sobre o que funcionou bem e o 
